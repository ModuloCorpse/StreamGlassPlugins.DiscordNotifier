...
namespace DiscordNotifierPlugin
{
    ...
    {
        public class JsonSerializer : AJsonSerializer<NotificationSetting>
        {
            protected override OperationResult<NotificationSetting> Deserialize(JsonObject reader)
            {
            ...
            protected override void Serialize(NotificationSetting obj, JsonObject writer)
            {
